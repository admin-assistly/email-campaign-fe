        ...
        <div className="w-full max-w-md">
          ...
          <Card className="shadow-lg border-0 bg-white">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-3xl text-[#333333]">Create Account</CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="repeatPassword" className="text-[#333333]">Confirm Password</Label>
                  <div className="relative">
                    <Input
                      id="repeatPassword"
                ...
                <div className="space-y-2">
                  <Label htmlFor="securityQuestion" className="text-[#333333]">Security Question</Label>
                  <select
                    id="securityQuestion"
                    value={formData.securityQuestion}
                    onChange={(e) => setFormData({ ...formData, securityQuestion: e.target.value })}
                    className="flex h-12 w-full rounded-md border border-[#D1D9E4] bg-background px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm text-[#333333]"
                    required
                  >
                ...
                <div className="space-y-2">
                  <Label htmlFor="securityAnswer" className="text-[#333333]">Security Answer</Label>
                  <Input
                    id="securityAnswer"
                    type="text"
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="agreeToTerms" className="text-sm text-[#8B94A3]">
                    I agree to the{' '}
                    <Link href="/terms" className="text-[#30C7D5] hover:underline">
                      Terms of Service
                    </Link>
                    {' '}and{' '}
                    <Link href="/privacy" className="text-[#30C7D5] hover:underline">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
          ...
          <div className="text-center mt-6">
            <p className="text-[#8B94A3]">
              ...
              <Link href="/login" className="text-[#30C7D5] hover:underline">
                Sign in
              </Link>
            </p>
          </div>
